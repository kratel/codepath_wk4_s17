    ...
    if (empty($errors)) {
      ...
      if($user) {
        if($password === $master_password) {
          ...
          $errors[] = "Invalid Login Credentials"; // TODO write an error message, Error message same to prevent username search and dictionary attack
        }
      } else {
        // No username found
        $errors[] = "Invalid Login Credentials"; // TODO write an error message
      }
    }
  } else {
